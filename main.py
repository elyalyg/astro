...
def add_arguments(parser):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Path to a TXT file listing training sample paths (one per line)'
    )
    parser.add_argument(
        '--val_list',
        type=str,
        default=None,
        help='Path to a TXT file listing validation sample paths (one per line)'
    )
